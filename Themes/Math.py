...
# Функция `math.gcd()` возвращает наибольший общий делитель этих чисел, который затем присваивается переменной `x`. 
# Это приводит к тому, что x принимает значение 15, так как наибольший общий делитель чисел 105, 45 и 30 равен 15.
